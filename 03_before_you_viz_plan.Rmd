...
![](./img/research_data_pipeline.png)
...
Here is a non-exhaustive list of open source tools we recommend for data visualization:

* Static visualizations:
   * [Ggplot](https://ggplot2.tidyverse.org/) in R
