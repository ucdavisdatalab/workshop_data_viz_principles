...
You are now ready to make your plot! There are many types of statistical graphics that you can choose from to showcase your data. Each type has its benefits, and drawbacks, based on how it combines marks and channels to encode your data. Match the chart type to your data - and what you want it to show - and not the other way around.
...
* What specific visual that best supports those tasks?
* What do we expect people to do in their visual queries?
* How can we use graphical marks and channels to support the queries to be faster?

Step 3: Select a Plot Type
-------------------

Now that you've identified your data types and what you need your visualization to show, explore different chart type options using this nifty tool by [from Data to Viz](https://www.data-to-viz.com/). Click through the plot thumbnails to learn about their pros, cons, and alternate options.

![](./img/from_data_to_viz_screengrab.PNG)

For example, if you want to enable comparing individual quantitative values and their relationships, try a dot or scatter plot. When you want to make accurate comparisons, try a chart with lines or bars sitting on a single axis.

Here's an overview of some of the most common plot type you'll encounter:
...
But what about maps?! [Geospatial data visualization is complex and has its own workshop.](https://datalab.ucdavis.edu/eventscalendar/dsi-workshop-geospatial-data-visualization/)
