...
Google also has an [interactive plot gallery](https://developers.google.com/chart/interactive/docs/gallery?csw=1
And [this Stack Exchange post](https://stats.stackexchange.com/questions/78844/a-gallery-of-charts-diagrams-and-plot-types) has even more chart type resources.

The following list contains an overview of some of the most common plot type you may encounter. 
