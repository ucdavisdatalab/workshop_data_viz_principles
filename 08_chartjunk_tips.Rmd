...
Just as an author edits before the novel, and an artist sketches before the masterpiece, plotting is an iterative process. Proofread for clarity and consistency. Check whether your plots pass the expressiveness and effectiveness tests. Does a viewer draw the same conclusions from the figure that you do?

Here's a ![cheatsheet summary of this reader](./datalab_worskhop_data_viz_cheatsheet.docx) to help you design and improve your data visualizations. Happy plotting!
