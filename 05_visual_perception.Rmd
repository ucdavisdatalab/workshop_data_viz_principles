...
Based on Steven's law, we can order encodings to help us identify which ones will more accurately allow us to judge relative magnitudes:
...
Expressiveness is violated when we use the encodings on the wrong side of the diagram for our data type.
Effectiveness means we should look look at the channels at the top of the list to encode the variables that are the most important to communicating our data story.
...
Our brains have an amazing ability to create and perceive structure in visual objects. This is commonly referred to as the Gestalt principles of visual perception. This framework combined with Steven's Law can help us think through how to use marks and channels expressive and effective data visualizations:
