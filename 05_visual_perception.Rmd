...
Taking these principles together, when we want to compare magnitudes of **ordinal data** (numeric, continuous, or ordered qualitative data - like heigh, weight, number of children in a family, or a rating), we should use encodings at the top of the list. Conversely, for **nominal data** (categorical or un-ordered qualitative data - like gender), use these identity channels: 
